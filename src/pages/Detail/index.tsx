...
import { FiPlay } from "react-icons/fi"; // استيراد أيقونة التشغيل
...
const Detail = () => {
  ...
  // دالة التعامل مع ضغطة زر المشاهدة
          ...
          >
            ...
            <m.div variants={fadeDown}>
              <button 
                ...
                className="flex items-center gap-2 bg-primary hover:bg-red-700 text-white px-8 py-3 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg shadow-red-600/40 w-fit mt-2 mb-2"
              >
                <FiPlay fill="white" />
                WATCH NOW
              </button>
